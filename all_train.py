...
for epoch in range(epochs):
    ...
    for image1,image2,image3,labels in train_loader:
        ...
        feature_1 = torch.reshape(feature_1,(16,-1,32,32))
        feature_2 = torch.reshape(feature_2,(16,-1,32,32))
        feature_3 = torch.reshape(feature_3,(16,-1,32,32))
    ...
    steps = epoch*len(train_loader.dataset)/16
